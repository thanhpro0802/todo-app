...
export const DraggableTaskItem: React.FC<DraggableTaskItemProps> = ({
  ...
  const {
    ...
    id: task.id,
    disabled: isEditing || showDeleteConfirm || isDragOverlay,
  });
  ...
  return (
    <div
      ...
      } ${isDragging ? 'shadow-lg opacity-75 rotate-3' : ''} ${
    ...
    >
      ...
      <div className="flex items-start gap-3">
        {/* Drag Handle */}
        {!isEditing && !showDeleteConfirm && !isDragOverlay && (
          <button
            {...attributes}
            {...listeners}
              ...
              {isEditing ? (
                ...
                <div>
                  <h3
                    ...
                    onClick={() => !isDragOverlay && setShowDetails(!showDetails)}
                  >
                    {task.text}
                  </h3>
      ...
      {/* Delete Confirmation */}
      {showDeleteConfirm && !isDragOverlay && (
